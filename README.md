# sfmlProject_Game1
A cross-platform [SFML](https://www.sfml-dev.org) 2.5.1 & C++17 build environment for [Visual Studio Code](https://code.visualstudio.com/).  Attempt to code a 2D game (unknown at this time) using C++ and sfml.
